...
public class Forudgah_New extends Agent {
 	private static final long serialVersionUID = 1L;
	Agent a1 = new Agent();
	public AID MASC_B_AID;
	Func func = new Func();

	
	int offsettime = 100;

	String adjag1 = "Forudgah";
	String adjag2 = "Gomrok_Mehrabad";
	String adjag3 = "";
	String adjag4 = "";
	String adjag5 = "";
	String adjag6 = "";
	...
	MASC_B_AID = new AID("MASC_B", AID.ISLOCALNAME);
